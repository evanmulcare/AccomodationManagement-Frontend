...
function NewPayment() {
    ...
    function validationChecks() {
        ...
        if (!input.caravanid) {
            ...
            errors.push("Caravan ID should be in the format of 'C' followed by 2 digits i.e E01");
        }
    ...
    function handleClick(event) {
       ...
       const NewPayment = {
        ...
        axios.post('https://accomodationmanagementbackend.onrender.com/payments', NewPayment)
...
return <div className='m-2 md:m-10 p-2 md:p-10 bg-white rounded-3xl grid h-screen place-items-center'>
        <Link to='/payments'><BiExit className='text-2xl mt-5 mb-5 cursor-pointer'/></Link>
