...
const EmployeeView = () => {
  ...
  const { id } = useParams();
    ...
    useEffect(() => {
      Axios.get(`https://accomodationmanagementbackend.onrender.com/employees/${id}`)
      .then(res => {
        console.log(res)
        setData(res.data)
      })
    ...
    useEffect(() => {
      Axios.get('https://accomodationmanagementbackend.onrender.com/payrolls')
      .then(res => {
        console.log(res)
    ...
    const payrollDelete = ( id, e) => {
      e.preventDefault();
      Axios.delete(`https://accomodationmanagementbackend.onrender.com/payrolls/${id}`)
        ...
        return (
          <tr className="bg-white shadow-md">
            ...
            <td className="px-6 py-4 whitespace-nowrap">
              <div className="text-sm text-gray-900">{payrollData.createdAt}</div>
            </td>
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
              <div className="flex items-center justify-center space-x-2">
                <button
                  onClick={(e) => payrollDelete(data._id, e)}
  ...
  <div className='ml-4'>
    ...
    <h5 className='font-semibold text-lime-600'>Staff</h5>
  </div>
</div>
<Link to='/employees'>
  <BiExit className='ml-auto text-4xl mt-5 mb-5 cursor-pointer text-gray-600 hover:text-gray-200' />
        ...
        <div className='p-5 mt-10'>
          ...
          <div className='text-gray-700'>
            ...
            <div className='flex flex-col md:flex-row'>
              <div className='md:w-1/2'>
                <h4 className='font-semibold mb-2'>Employee ID:</h4>
                <p>{data.employeeid}</p>
              </div>
            </div>
          </div>
        ...
        <div className='p-5 mt-10'>
          <h3 className='font-bold text-gray-400 text-lg mb-4'>Payroll</h3>
          <hr className='my-4' />
          <div className='text-gray-700'>
            ...
            <tr>
              ...
              <th className='w-1/6 p-3 text-left text-xs font-semibold tracking-wider text-gray-500 uppercase'>EID</th>
