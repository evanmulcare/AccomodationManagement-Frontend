...
const Payroll = () => {
  ...
  const exportToExcel = () => {
    ...
    writeFile(workbook, 'payroll.xlsx');
  };
    ...
    return (
      <div className='bg-white rounded-lg shadow-md p-4 space-y-4'>
        <div className='flex items-center space-x-2 text-lg font-semibold'>
          ...
          <div className='text-gray-500 text-sm'>{data.employeeid}</div>
        </div>
  ...
  return (
    <div className='m-2 md:m-10 p-2 md:p-10 bg-white rounded-3xl '>
      ...
      <div className='flex justify-between items-center mb-6'>
        ...
        <div>
        <Link to="/new-payroll">
        <button className='bg-lime-700 hover:bg-lime-600 text-white font-medium py-2 px-4 mx-2 rounded-md'>Add Payroll</button>
        </Link>
        <button 
